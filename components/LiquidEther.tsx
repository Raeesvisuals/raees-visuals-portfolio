  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      dispose() {
        ...
        this.container.removeEventListener('touchstart', this.onDocumentTouchStart, false);
        this.container.removeEventListener('touchmove', this.onDocumentTouchMove, false);
        this.container.removeEventListener('mouseenter', this.onMouseEnter, false);
        this.container.removeEventListener('mouseleave', this.onMouseLeave, false);
